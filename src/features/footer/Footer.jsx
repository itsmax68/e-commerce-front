    ...
    <Stack sx={{backgroundColor:theme.palette.primary.main,paddingTop:"3rem",paddingLeft:is700?"1rem":"3rem",paddingRight:is700?"1rem":"3rem",paddingBottom:"1.5rem",rowGap:"5rem",color:theme.palette.primary.light,justifyContent:"space-around"}}>
            ...
            <Stack flexDirection={'row'} rowGap={'1rem'} justifyContent={is700?"":'space-around'} flexWrap={'wrap'}>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    ...
                    <Typography sx={labelStyles} component={Link} to="/login">
                      Login
                    </Typography>
                    <Typography sx={labelStyles} component={Link} to="/signup">
                      Register
                    </Typography>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    ...
                    <Typography sx={labelStyles} component={Link} to="/privacy-policy">
                      Privacy Policy
                    </Typography>
                    <Typography sx={labelStyles} component={Link} to="/terms-of-use">
                      Terms Of Use
                    </Typography>
                    <Typography sx={labelStyles} component={Link} to="/faq">
                      FAQ
                    </Typography>
                    <Typography sx={labelStyles} component={Link} to="/contact">
                      Contact
                    </Typography>
                </Stack>
