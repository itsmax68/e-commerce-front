    ...
    extraReducers:(builder)=>{
        builder
            ...
            .addCase(deleteProductByIdAsync.fulfilled,(state,action)=>{
                ...
                if (removedId) {
                    state.products = state.products.filter((product) => product._id !== removedId)
                    const next = Number(state.totalResults) - 1
                    state.totalResults = Number.isFinite(next) && next >= 0 ? next : 0
                }
            })
