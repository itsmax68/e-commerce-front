            ...
            {!(productFetchStatus === 'rejected' && reviewFetchStatus === 'rejected') && <Stack sx={{ justifyContent: 'center', alignItems: 'center', mb: '2rem', rowGap: "2rem" }}>
                {
                    (productFetchStatus || reviewFetchStatus) === 'pending' ?
                        ...
                        <Stack>
                            ...
                            {/* product details */}
                            <Stack width={is480 ? "auto" : is1420 ? "auto" : '88rem'} p={is480 ? 2 : 0} height={"auto"} rowGap={5} mt={is840 ? 0 : 5} justifyContent={'center'} mb={0} flexDirection={is840 ? "column" : "row"} columnGap={is990 ? "2rem" : "5rem"}>
                                    ...
                                    <Stack mt={is480 ? "0rem" : '5rem'}>
                                        {
                                            is1420 ?
                                                                ...
                                                                <div key={index} style={{ width: "100%", height: '100%' }}>
                                                                    {
                                                                        Math.abs(activeStep - index) <= 2
                                                                            ?
                                                                            <Box component="img" sx={{ width: '100%', height: is480 ? "300px" : is990 ? "400px" : "500px", objectFit: "contain", overflow: "hidden" }} src={image} alt={product?.title} />
                                                                            :
                                                                            null
                                                                    }
                                                                </div>
                                                ...
                                                :
                                                <div style={{ width: "100%" }}>
                                                    <img style={{ width: "100%", height: "500px", objectFit: "contain" }} src={product?.images[selectedImageIndex]} alt={`${product?.title} image`} />
                                                </div>
                                        }
                                    </Stack>
                                ...
                                <Stack rowGap={"1.5rem"} width={is480 ? "100%" : '25rem'}>
                                    ...
                                    <Stack rowGap={".5rem"}>
                                        ...
                                        {/* price */}
                                        <Typography variant='h5'>{formatINR(product?.price)}</Typography>
                                    </Stack>
